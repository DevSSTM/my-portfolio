            ...
            <div className="max-w-7xl w-full z-10 grid md:grid-cols-2 gap-12 items-center px-4">
                ...
                >
                    ...
                    <motion.h1 variants={itemVariants} className="text-4xl md:text-7xl font-bold mb-6 leading-tight">
                        ...
                        <br />
                        <span className="text-2xl md:text-3xl block mt-2 font-medium text-gray-300">Bringing Vision to Life through Strategy & Tech</span>
                    </motion.h1>

                    <motion.p variants={itemVariants} className="text-base md:text-lg text-gray-400 mb-8 max-w-lg mx-auto md:mx-0 leading-relaxed">
                    ...
                    <div className="flex flex-wrap items-center gap-4 justify-center md:justify-start">
                        ...
                        <a href="/CV/S.T.M.Sakalasooriya (CV).pdf" download className="inline-block text-sm text-gray-300 hover:text-white border-b border-transparent hover:border-white transition-colors p-2">Download CV</a>
                    </div>
                </motion.div>

                <motion.div
                    className="order-1 md:order-2 flex justify-center items-center py-8 md:py-0"
                    initial={{ opacity: 0, scale: 0.8 }}
                    animate={{ opacity: 1, scale: 1 }}
                    transition={{ duration: 0.8, delay: 0.5 }}
                >
                    <div className="relative w-64 h-64 sm:w-80 sm:h-80 md:w-[450px] md:h-[450px] group">
                        ...
                        <div className="absolute inset-[5%] rounded-full border-[10px] md:border-[18px] border-[#6366f1] shadow-[0_0_80px_rgba(99,102,241,0.5),inset_0_0_30px_rgba(99,102,241,0.3)] z-10 pointer-events-none" />
                        ...
                        <div className="absolute top-0 right-0 w-32 h-32 md:w-48 md:h-48 bg-[#6366f1]/30 blur-[60px] md:blur-[80px] rounded-full animate-pulse" />
                        <div className="absolute bottom-0 left-0 w-32 h-32 md:w-48 md:h-48 bg-secondary/30 blur-[60px] md:blur-[80px] rounded-full animate-pulse delay-1000" />

                        {/* Floating Badge */}
                        <div className="absolute bottom-2 right-2 md:bottom-4 md:right-4 z-20 glass-panel px-3 py-1 md:px-4 md:py-2 rounded-xl border border-white/10 animate-float">
                            <span className="text-xs md:text-sm font-bold text-white">Available for Projects</span>
                        </div>
                    </div>
                </motion.div>
            </div>
